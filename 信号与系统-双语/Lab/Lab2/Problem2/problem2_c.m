...
d1 = [zeros(1,length(-1:0.05:-0.05)) 1/delta1*ones(1,length(0:0.05:delta1-0.05)) zeros(1, length(delta1:0.05:4))];
d2 = [zeros(1,length(-1:0.05:-0.05)) 1/delta2*ones(1,length(0:0.05:delta2-0.05)) zeros(1, length(delta2:0.05:4))];
d3 = [zeros(1,length(-1:0.05:-0.05)) 1/delta3*ones(1,length(0:0.05:delta3-0.05)) zeros(1, length(delta3:0.05:4))];
